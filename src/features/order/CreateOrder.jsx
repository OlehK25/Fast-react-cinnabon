...
import {
  ...
  getCartItems,
  getTotalCartPrice,
} from "../card/cartSlice.js";
import EmptyCart from "../card/EmptyCart.jsx";
    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            className="h-6 w-6 accent-slate-400 focus:outline-none
              focus:ring focus:ring-slate-400 focus:ring-offset-2"
            type="checkbox"
            name="priority"
            id="priority"
            value={withPriority}
